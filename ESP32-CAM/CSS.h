// String to save HTML code used the render the webpage of the server
String webpage = "";

void append_page_header() 
{
  // F() is a macro particular to the Arduino IDE.
  // It stores strings that would've otherwise occupied space in SRAM in flash memory instead.
  webpage  = F("<!DOCTYPE html><html>");
  webpage += F("<head>");
  webpage += F("<title>ESP32-CAM Server</title>"); 
